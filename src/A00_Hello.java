...
/* 
 	# 주석(comment)
  	...
  	- 컴파일시 무시되기 때문에 프로그램 실행에 영향을 미치치 않는다
...
/*
  ...
  - [Win] + E : 탐색기
  - [Win] + 방향키 : 창 크기 조절
  - [Win] + Shift + S : 스크린샷 (스크린샷 후 카톡 등에 복붙 가능)
 ...
 # Eclipse 단축키 
  ...
  - Shift + End : 현재 커서 위치부터 맨 위까지 블록지정
  - Ctrl + A : 전체 문서를 블록지정
  - Ctrl + C : 복사하기
  - Ctrl + X : 잘라내기
...
public class A00_Hello {
	// Eclipse에서 빨간줄이 생겼을 때(에러) 그곳에 커서를 두고 F2를 누르면
	...
	public static void main(String[] argrs) {
		...
		/*
		  ...
		  - 우리가 만든 프로그램은 실제 콘솔에서도 동일하게 동작한다
		  	(cmd, cd, java ...)
		  - 제작한 소스코드(.java)의 컴파일 결과(.class)는 프로젝트
		  	내부의 bin 폴더에 저장된다
		...
		System.out.println("true"); // 서로 다른 기능을 함

...
public class C01_Method {
	/*
	  ...
	  - 나중에 재사용할 가능성이 있는 기능들을 함수로 만들어두면 
	    작업의 반복을 줄일 수 있다
	 ...
	 # 함수의 선언
	  ...
	  - 함수의 이름 : 나중에 호출할 때 사용하고 싶은 이름
	  - return : 해당 함수를 끝마치면서 값을 호출한 곳에 돌려준다
	  
	  # 함수의 리턴 (return)
	  - 해상 함수가 반환하는 값의 타입을 지정할 수 있다
	  ...
	  - 매개 변수의 개수에는 제한이 없다
	  - 매개 변수에 ...을 찍으면 여러 개의 해당 타입 값을 배열로 받을 수 있다  
	...
	public static void main(String[] args) {
		...
		// 리턴 타입이 있는 함수는 해당 값을 반드시 리턴한다.
		int a = plus(1, 2);
		String str = repeat(3, "L");
		
		System.out.println(repeat(5, "hello! "));
		System.out.println(repeat(5, "bye! "));

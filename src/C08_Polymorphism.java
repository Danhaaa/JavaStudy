import myobj.AirFryer;
import myobj.Electronics;
import myobj.VacuumCleaner;
 ...
 */
	...
	public static void main(String[] args) {
		...
		// 전자제품 타입 변수에 들어갈 수 있다 (업캐스팅) -> 부모타입으로 올라간다는 뜻
		...
		// 업캐스팅된 객체가 자식 클래스에만 존재핳던 기능을 사용하고 싶다면
	...
	public static void printElectronicsInfo(Electronics product) {
		product.info(); // 진공청소기나 에프 관련 인포는 쓸 수 없다
	}

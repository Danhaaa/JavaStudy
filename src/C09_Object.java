...
/*
  ...
  - Object 클래스의 메서드는 주로 해당 클래스에 맞는 형태로 오버라이드 하여 사용한다
   ...
   - '해당 인스턴스가 문자열로 표현된다면 어떤 모양이어야 하는가'를 정의해놓은 메서드
   - 주로 print() 메서드들이 해당 인스턴스의 toString()을 호출하도록 설계 되어 있다
 ...
 */
	...
	public static void main(String[] args) {
		...
		System.out.println(a2.toString()); // toString에서 F3 눌러보기 
		...
		System.out.println(g1 == g2); // 두개는 주소값이 다르다

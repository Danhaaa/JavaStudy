...
public class B14_Array {
	...
	/*
	  # 배열
	  - 같은 타입 변수를 한번에 여러 개 선언하는 문법
	  - 같은 이름으로 변수를 여러 개 선언한 후 각 번호를 방 번호(index)로 구분한다
	  - 배열은 반드시 선언과 동시에 크기를 정해야 한다
	  - 크기가 정해지고 나면 크기를 변경할 수 없다
	  - 배열의 인덱스는 0 ~ 길이 -1까지 있다
	...
	public static void main(String[] args) {
		...
		String[] animals = {"zebra", "monkey", "pig", "cat", "dog"};
	...
	//	System.out.println(animals[999]);
		...
		String fruit = "Dragon fruit";
		System.out.println(fruit);
		
		
		// 배열의 값은 초기화 한 적 없어도 사용 가능
		String[] fruits = new String[15];
		
		fruits[0] = "Initialized Fruit";
		
		// 초기화한 적 없는 fruit[7]도 사용할 수 있다
		...
		// System.out.println(complete[22]); // boolean 21은 0부터 21번까지만 답이 있어서

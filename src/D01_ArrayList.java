...
public class D01_ArrayList {
	/*
	  ...
	  # Java Collection Interface
	   - 자바의 라이브러리(자바가 미리 만들어놓은 클래스들)들에 대한 정보는
	   	 Java API 문서를 확인하여 정확히 파악할 수 있다
	...
	public static void main(String[] args) {
		...
		// list.addAll(index, Collection): 원하는 위치에 원하는 컬렉션 데이터 추가
	...
	ArrayList<String> snacks = new ArrayList<>(); // 나는 String만 쓰겠다는 표시
	...
	System.out.println(snacks);
	System.out.println(snacks.get(1));
	
	// list.contains(item): 리스트에 해당 값이 포함되어 있는지 여부를 반환
	System.out.println("리스트에 고구마깡이 있나요? " 
					+ snacks.contains("고구마깡"));
	...
	System.out.println("지워진 후 모습: " + snacks);

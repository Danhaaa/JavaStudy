...
public class D08_String {
	...
	public static void main(String[] args) {
		...
		// join(delim, iterable) : 해당 iterable 객체에 들어있는 모든 요소를 delim로 
		// 								이어붙인 하나의 문자열을 반환
		// ※ iterable - 베열, 리스트 등 하나씩 꺼낼 수 있는 성질을 의미하는 인터페이스
		...
		// contains(seq) : 해당 문자열의 포함 여부를 반환
		...
		// subString(start, end) : 문자열의 일부분을 자른 인스턴스를 반환한다 (자주 쓰임)
		...
		System.out.println("입력: " + input.trim());
		...
		System.out.println(fruits.indexOf("apple")); // 두 개일 경우는 가장 처음 찾은 것만 반환

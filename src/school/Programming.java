...
public class Programming extends Subject {
	...
	public Programming(int kor, int eng, int math, int programmingLanguage, 
			int operatingSystem, int dataStructure) {
		this.kor = kor;
		this.eng = eng;
		this.math = math;
	...
	@Override
	public int getTotal() {
		return kor + eng + math + programmingLanguage 
	...
	public int[] getSubjectScores() {
		return new int[] {kor, eng, math, programmingLanguage, 
				operatingSystem, dataStructure};

...
public class A05_VarNaming {
	...
	public static void main(String[] args) {
		...
		System.out.println("사과의 g당 가격: " + apple_price/apple_weight + "원");

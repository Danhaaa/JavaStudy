...
/*
 	...
 	* 서식 문자의 종류
 	  ...
 	  * 서식 문자 옵션 - 서식 문자의 %와 문자 사이에 넣어서 사용한다
 	    ...
 	    3. %0숫자d
 	       - 숫자만큼 자릿수를 확보하고 빈자리를 0을 채우면서 출력
 ...
 */
	...
	public static void main(String[] args) {
		...
		+ date + "일이고, 현재 시간은 " + hour + "시 " + minute + "분 " + second + "초 입니다.\n");
		...
		int a = 3351;
		System.out.printf("a는 10진수로 %d이고, 16진수로 %x입니다\n\n"
				, a, a);
		...
		String message = "Nice to meet you!";
				...
				System.out.printf("%s님이 남긴 메세지입니다. \"%s\"\n", name, message);

	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 필드값에 그냥 접근하도록 허용하지 않고 
		   getter와 setter를 통해 접근하도록 한다
		 - getter와 달아놓으면 읽기 전용 데이터 클래스가 된다 (VO, Value Object)
		...
		try(
			...
			while(rs.next()) {
				...
				f.setCountry_id(rs.getString("country_id")); // 꺼내는 작업 끝
		...
		// DB연결 부분에서 활용하기 보다는 컬렉션에 담아놓은 후 활용하는 것이 좋다

...
public class B00_Scanner {
	...
	/*
	 	# java.util.Scanner 클래스
	 	  ...
	 	  - 프로그램으로 입력을 받을 수 잇는 여러 기능들이 모여있는 클래스
	 	  - 어느곳으로부터 입력 받을 지 결정한 뒤 스캐너를 생성하여 사용한다
	...
	public static void main(String[] args) {
		...
		// 같은 패키지의 다른 클래스는 import 없이 사용 가능
		A00_Hello.main(null);
		A01_Escape.main(null);
		
		// 다른 패키지의 다른 클래스는 사용하려면 import 필요
		...
		// next()는 한 단어씩 입력을 꺼낸다
		String str1, str2;
		
		System.out.println("단어를 두 개 입력해주세요 >> ");
		str1 = sc.next();
		str2 = sc.next();
